...
directory = 'F:\RH_Local\Rich data\scanimage data\20191110\mouse 10.13A';
file_baseName = 'baseline_00002_';
...
duration_total = size(F_roi,1)/Fs_frameRate;
clear total_rewards_per30s all_rewards all_cursor baselineState baselineHoldState thresholdState
cc = 1;
for ii = threshVals
    tic
